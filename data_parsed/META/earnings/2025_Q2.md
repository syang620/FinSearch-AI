...
### Mark Elliot Zuckerberg (Unknown)

All right. Thanks, Ken. Thanks, everyone, for joining today. We had another strong quarter with more than 3.4 billion people using at least one of our apps each
...
In terms of the specific line items, cost of revenue increased 16%, driven mostly by higher infrastructure costs and payments to partners, partially offset by a

benefit from the previously announced extension of sever useful lives. R&D increased 23%, mostly due to higher employee compensation and infrastructure 
...
5% on Instagram and 3% on Facebook Feed and Reels in Q2. Finally, we expanded coverage of our Lattice model architecture in Q2. We first began deploying

Lattice in 2023 with our later-stage ads ranking efforts, allowing us to run significantly larger models that generalize learnings across objectives and surfaces in
...
Mark, when you think about where the AI parts of your business have been evolving over the last 3 to 6 months, I wanted to know what your key learnings were
...
CapEx over the next 12 to 18 months.

### Mark Elliot Zuckerberg (Unknown)

Yes, sure. I can start. At a high level, I think that there are all these questions that people have about what are going to be the time lines to get to really strong AI 
...
the fastest assumptions have been the ones that have most accurately predicted what would happen. And I think that, that just continued to happen over the

course of this year, too. And so I've given a number of those anecdotes on these earnings calls in the past. And I think, certainly, some of the work that we're
...
I have two. The first one, Mark, just to kind of go back to the intelligence labs and sort of the vision for superintelligence. As you sort of sit here now versus 12
...
you think could drive a further lift to engagement on the core platform?

### Mark Elliot Zuckerberg (Unknown)

Yes, sure. I mean in terms of the research agenda and a bunch of the areas that we're very focused on, I do think focusing on self- improvement is a very
...
we surface are the most relevant to what they're interested in at that moment. And we're making optimizations to help the best content from smaller creators

break-out by matching it to the right audiences sooner after it gets posted. And we're also working on improving the ability for our systems to discover more
...
One for Mark and one for Susan. Mark, Meta has been a huge proponent of open source AI, has your thinking changed here at all, just as you pursue
...
than $100 billion of spend next year potentially. Do you continue to expect to finance all this yourself? Or could there be opportunities to partner here?

### Mark Elliot Zuckerberg (Unknown)

Yes. I mean on open source, I don't think that our thinking has particularly changed on this. We've always open sourced some of our models and not open
...
I'll ask another one on infrastructure. Mark, your spend is now approaching some of the biggest hyperscalers out there. Do you think of all this capacity mostly for
...
Mark, as you go after the superintelligence vision, especially for those of us on the outside, what are kind of some of the markers or KPIs that you're tracking on
...
change or adjustment to how you think about the relationship between revenues or core business performance and the cadence of investment?
...
Mark, I wanted to ask you on Meta AI, and I think you talked about in the call just growing engagement overall, particularly on WhatsApp. And now we have 1
...
Yes, I'm not going to get super deep into the road map on this, but the basic -- we do see that as we continue improving the models behind Meta AI and post
...
### Youssef Houssaini Squali (Unknown)

I have two. So Mark, the Ray-Ban initiative has been a [ hallmark ] for you guys so far. Where are we on the development of glasses? And has that new
...
next couple of years? Is it fair to assume it will grow materially faster than the revenue and OpEx? And how do you minimize shareholder dilution?

### Mark Elliot Zuckerberg (Unknown)

Yes, I can talk a bit about the glasses. Yes, I mean, I'm very excited about the progress that we're making. I think both the Ray-Ban Metas and I'm very excited 
...
Once you get a display in there, whether it's the kind of wide holographic field of view like we showed with Orion or just a smaller display that might be good for

displaying some information, and that's also going to unlock a lot of value where you can just interact with an AI system throughout the day in this multimodal
...
Sure. Just as you look at the spend on stock-based compensation over the next couple of years with all these hires, I'm assuming that we're going to see that
